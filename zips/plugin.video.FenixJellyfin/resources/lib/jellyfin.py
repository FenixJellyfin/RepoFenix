...
class API:
    def __init__(self, server=None, user_id=None, token=None):
        # FORÇAR URL AQUI
        self.server = 'https://cat.seedhost.eu/tugateamvod/jellyfin'
        ...
        self.headers = {}
        self.create_headers()
        # DESATIVAR VERIFICAÇÃO DE CERTIFICADO (Muitas Seedhosts precisam disto)
    ...
    def get(self, path):
        ...
        # COMENTA ESTAS LINHAS para não voltar a ler do Kodi:
        # if not self.server:
        #     self.settings = xbmcaddon.Addon()
...
# URL fixo definido explicitamente
SERVIDOR_FIXO = 'https://cat.seedhost.eu/tugateamvod/jellyfin'
